...
const EventSchema = new Schema({    
    ...
    category: { type: String, enum: ['Arts&Culture','Food&Drink','Business&Networking', 'LifeStyle','Health', 'Community'], trim: true },
    ...
    status : { type: String, trim: true, enum: ['ongoing', 'cancelled', 'completed'], required: true }
},{timestamps : true});
